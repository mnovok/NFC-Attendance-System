...
function StudentDashboard() {
  ...
  const [email, setEmail] = useState('jungkook@bts.com'); // This should be passed via props or fetched from a context

  useEffect(() => {
    // Here we simulate an API call for attendance data
    // In a real app, you'd fetch this data from an API endpoint
    const mockAttendanceData = [
      { day: 'danas', className: 'Napredne arhitekture računala', status: 'Prisutan', type:'predavanje' },
      { day: '09.01.2025.', className: 'Poslovni informacijski sustavi', status: 'Prisutan', type:'lab'},
      { day: '09.01.2025.', className: 'Paralelno programiranje', status: 'Neprisutan', type:'predavanje' },
      { day: '07.01.2025.', className: 'GRID računalni sustavi', status: 'Prisutan', type:'vjezbe' },
    ];
